...
public class Configuration<B extends PircBotX> {
    ...
    protected ImmutableList<String> ciphers;
    ...
    protected Configuration(Builder<B> builder) {
        ...
        checkNotNull(builder.getCiphers());
        ...
        this.ciphers = ImmutableList.copyOf(builder.getCiphers());        
    }
    ...
    public static class Builder<B extends PircBotX> {
        ...
        protected final List<ChannelModeHandler> channelModeHandlers = new ArrayList<>();
        /**
         * The {@link BotFactory} to use
         */
        protected BotFactory botFactory = new BotFactory();
        /**
         * The {@link Ciphers} to use
         */
        ...
        public Builder(Configuration<B> configuration) {
            ...
            this.ciphers.addAll(configuration.getCiphers());
        }
        ...
        public Builder(Builder<B> otherBuilder) {
            ...
            this.ciphers.addAll(otherBuilder.getCiphers());
        }
