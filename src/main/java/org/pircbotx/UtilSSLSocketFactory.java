 ...
 *
 * @author Trusting all certificates code by
 * <a href="http://www.howardism.org/Technical/Java/SelfSignedCerts.html">Howardism</a>
 * <p>
 * Disabling Diffie Hellman code by
 * <a href="http://stackoverflow.com/questions/6851461/java-why-does-ssl-handshake-give-could-not-generate-dh-keypair-exception/6862383#6862383">Sam
 * on StackOverflow</a>
 * <p>
...
public class UtilSSLSocketFactory extends SSLSocketFactory {
    ...
    @Getter
    protected List<String> ciphers = new LinkedList<>();
