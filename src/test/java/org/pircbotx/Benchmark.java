...
public class Benchmark {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int userNum = 0; userNum < MAX_USERS; userNum++) {
            ...
            for (int channelNum = 0; channelNum < MAX_CHANNELS; channelNum++) {
                ...
                for (int iterationNum = 0; iterationNum < MAX_ITERATIONS; iterationNum++) //Parse template
                {
     ...
     * @return
     */
    private static void shuffleArray(String[][] array, Random rnd) {
    ...
    private static int run(StopWatch stopWatch) throws IOException, IrcException {
        int counter = 0;
        stopWatch.start();
