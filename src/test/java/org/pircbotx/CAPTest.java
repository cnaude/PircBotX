...
public class CAPTest {
    ...
    public void runTest(String cap, final OutputParser callback) throws Exception {
        final MutableObject<Exception> connectionException = new MutableObject<>();
            ...
            public synchronized void write(byte[] bytes, int i, int i1) {
                ...
                try {
                    try {
                        ...
                        if (callbackText == null) //Will close bots input loop
                        {
                            botInWrite.close();
        ...
        runTest("sasl", new OutputParser() {
            ...
            public String handleOutput(String output) throws Exception {
                if (output.equals("CAP REQ :sasl")) {
                    ...
                    return "AUTHENTICATE +";
                } else if (output.equals("AUTHENTICATE amlsbGVzAGppbGxlcwBzZXNhbWU=")) //Done
                {
                    return null;
                } else if (output.startsWith("AUTHENTICATE")) //Unknown AUTHENTICATE, most likely an invalid username/password
                {
    ...
    public void EnableTest() throws Exception {
        ...
        runTest("test-cap", new OutputParser() {
            ...
            public String handleOutput(String output) throws Exception {
                ...
                } else if (output.equals("CAP END")) //Done
                {
                    return null;
                }
                return "";
